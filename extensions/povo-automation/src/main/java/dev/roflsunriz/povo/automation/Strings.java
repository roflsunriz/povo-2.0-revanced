...
final class Strings {
    ...
    static String toppingDetected() { return pick("168時間トッピングの終了時刻を取得しました", "Detected the 168-hour topping expiry", "已检测到168小时套餐结束时间", "168 घंटे की समाप्ति मिली", "Se detectó el fin del topping de 168 horas", "Fin du forfait de 168 heures détectée", "تم اكتشاف انتهاء باقة 168 ساعة", "Fim do pacote de 168 horas detectado", "১৬৮ ঘণ্টার মেয়াদ শনাক্ত হয়েছে", "Обнаружено окончание пакета на 168 часов", "168 گھنٹے کی میعاد مل گئی"); }
    ...
    static String saveExpiry() { return pick("現在の終了日時を設定", "Set current expiry", "设置当前结束时间", "वर्तमान समाप्ति सेट करें", "Definir fin actual", "Définir la fin actuelle", "تعيين وقت الانتهاء الحالي", "Definir fim atual", "বর্তমান শেষ সময় সেট করুন", "Задать текущее окончание", "موجودہ اختتام مقرر کریں"); }
