...
public final class Automation {
    ...
    public static void registerPromoController(Object controller, String methodName) {
        promoController = controller;
        promoMethodName = methodName;
    ...
    public static void onAddonPayload(Object payload) {
        ...
        try {
            ...
            if (expiry != previous) {
                ...
                localState.setLastStatus("Current 168-hour topping detected");
                scheduleKnownExpiry();
            }
